        ...
        var datePicker = function(currentDate, options) {
            ...
            return $mdDialog.show({
                ...
                template: '<md-dialog aria-label="" class="mdp-datepicker" ng-class="{ \'portrait\': !$mdMedia(\'gt-xs\') }">' +
                            '<md-dialog-content id="datePickerDialogContent" layout="row" layout-wrap style="margin-left:-273px; margin-top:-142px; background-color:white; position:absolute; top:50%; left:50%;">' +
    ...
    return  {
        ...
        template: '<div layout layout-align="start start">' +
                    ...
                    '<md-input-container md-no-float class="md-block">' +
                        '<input type="{{ type }}" placeholder="{{ placeholder }}" value="{{ getValue() }}" aria-label="{{ placeholder }}" ng-readonly="true" />' +
                    '</md-input-container>' +
                '</div>',
        scope: {
            "minDate": "@min",
